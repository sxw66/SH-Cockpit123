...
Acesse a [página de lançamentos do GitHub](https://github.com/sxw66/SH-Cockpit123/releases) para baixar o pacote para o seu sistema:
...
[![Gráfico do Histórico do Star](https://api.star-history.com/svg?repos=sxw66/SH-Cockpit123&type=Date)](https://star-history.com/#sxw66/SH-Cockpit123&Date)

---

## Comunidade

Para dúvidas ou feedback, entre em contato com o autor:

- **QQ**: 1748931836
- **GitHub Issues**: [Enviar feedback](https://github.com/sxw66/SH-Cockpit123/issues)
